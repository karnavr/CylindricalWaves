...
# ╔═╡ 8abe844e-b48e-459b-b9da-29ea7b9e8c90
function y(x)
	out = sin.(x.^2)
	return out
end
...
# ╔═╡ 96d2377c-3aaf-47f7-a84c-6ebd4d4e1aa7


# ╔═╡ c7c10e1f-bee3-4153-a14c-1ad2c197b617
md"###### (Modified) Bessel Functions"

# ╔═╡ d22d5de4-8b0a-4328-b39d-2b7158a93055
begin
	bess_x = collect(range(0,4,100)) # domain
	
	# modified of first kind (I)
	bess_I = zeros(4,length(bess_x))
	for i = 0:3
